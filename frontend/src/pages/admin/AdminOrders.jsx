...
export default function AdminOrders() {
  ...
  const { getOrders, orders, isLoadingOrder, updateStatus, deleteOrder } =
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        <div className="bg-white rounded-2xl p-4 shadow-sm hover:shadow-md transition">
          ...
          <span className="text-2xl font-bold text-blue-600">
            {isLoadingOrder ? <Loader /> : pendingOrders}
          </span>
        </div>
        ...
        <div className="bg-white rounded-2xl p-4 shadow-sm hover:shadow-md transition">
          ...
          <span className="text-2xl font-bold text-yellow-600">
            {isLoadingOrder ? <Loader /> : preparingOrders}
          </span>
        </div>
        ...
        <div className="bg-white rounded-2xl p-4 shadow-sm hover:shadow-md transition">
          ...
          <span className="text-2xl font-bold text-green-600">
            {isLoadingOrder ? <Loader /> : completedOrders}
          </span>
        </div>
        ...
        <div className="bg-white rounded-2xl p-4 shadow-sm hover:shadow-md transition">
          ...
          <span className="text-2xl font-bold text-emerald-600">
            {isLoadingOrder ? <Loader /> : <span> ₹{totalRevenue}</span>}
          </span>
        </div>
      </div>
